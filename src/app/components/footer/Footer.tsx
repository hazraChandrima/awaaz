...
const Footer = () => {
  return (
    <>
      <footer className="mt-8 w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto border-t">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
          <div className="col-span-full hidden lg:col-span-1 lg:block">
            <a className="flex-none font-semibold text-xl text-black focus:outline-none focus:opacity-80" href="#" aria-label="Brand">Awaaz</a>
          ...
          <div>
            ...
            <div className="mt-3 grid space-y-3 text-sm">
              <p><a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-800" href="#">Home</a></p>
              <p><a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-800" href="#">Browse</a></p>
            </div>
          </div>

          <div>
            <h4 className="text-xs font-semibold text-gray-900 uppercase">Community</h4>
            ...
            <div className="mt-3 grid space-y-3 text-sm">
              ...
              <p><a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-800" href="#">Community Guidelines</a> </p>
            </div>
          </div>

          <div>
            <h4 className="text-xs font-semibold text-gray-900 uppercase">Support</h4>
            <div className="mt-3 grid space-y-3 text-sm">
              ...
              <p><a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-800" href="#">Privacy</a></p>
          ...
          <div>
            <h4 className="text-xs font-semibold text-gray-900 uppercase">Social</h4>
            <div className="mt-3 grid space-y-3 text-md">
              <a href="#" className=" text-gray-700 hover:text-gray-900 transition text-sm flex items-center space-x-2">
                <FaFacebook />
            ...
            <div className="flex flex-wrap items-center gap-3">
              <div className="hs-dropdown [--placement:top-left] relative inline-flex">
                ...
                <div className="hs-dropdown-menu w-40 transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden z-10 bg-white shadow-md rounded-lg p-2" role="menu" aria-orientation="vertical" aria-labelledby="hs-footer-language-dropdown">
                  ...
                  <a className="flex items-center gap-x-2 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100" href="#">
                    <svg className="shrink-0 size-3 rounded-full" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" id="flag-icon-css-cn" viewBox="0 0 512 512">
                      <defs>
