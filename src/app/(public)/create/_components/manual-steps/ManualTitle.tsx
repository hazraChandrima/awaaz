  ...
  const ManualTitle: React.FC<ManualTitleProps> = ({ title, setTitle, nextStep, prevStep }) => {
    return (
      <div className="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-md border border-gray-200">
        {/* Title Section */}
        <h1 className="text-3xl font-bold text-[#223843]">
        ...
        <label className="block mt-4 font-semibold text-[#223843]">
          Petition title
        </label>
        <input
          type="text"
        ...
        <span className="text-gray-500 text-sm block mt-1">
          {90 - title.length} characters left
        </span>
        ...
        <div className="mt-6 p-4 bg-[#E8EBE4] rounded-lg">
          ...
          <ul className="mt-2 text-gray-700 text-sm space-y-2">
            <li>
              <span className="font-bold">Keep it short and to the point</span>
              <br />
              Example: &quot;Buy organic, free-range eggs for your
              restaurants.&quot;
            </li>
            <li>
              <span className="font-bold">Focus on the solution</span>
              <br />
              Example: &quot;Raise the minimum wage to ₹300 a day.&quot;
            </li>
            <li>
              <span className="font-bold">Communicate urgency</span>
              <br />
