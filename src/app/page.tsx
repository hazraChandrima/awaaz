        ...
        <div className="max-w-5xl mx-auto px-4 xl:px-0 pt-24 lg:pt-32 pb-24">
          ...
          <div className="max-w-4xl">
            ...
            <div className="flex space-x-4 mt-2">
              <Link
                href={'/sign-up'}
                className="py-3 px-4 inline-flex items-center font-semibold text-sm rounded-md border border-[#CA3C25] text-[#CA3C25] bg-white focus:outline-none disabled:opacity-50 disabled:pointer-events-none"
              >
                Get Started
              </Link>
              <Link
