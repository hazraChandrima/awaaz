      ...
      <div className="bg-[#E8EBE4]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 sm:pt-24 lg:pt-32 pb-16 sm:pb-20 lg:pb-24">
          <h1 className="flex flex-wrap items-center font-semibold text-[#223843] text-4xl sm:text-5xl md:text-6xl text-center sm:text-left">
            <span
              className={`${abhaya.className} text-[#CA3C25] text-6xl sm:text-7xl md:text-8xl leading-tight`}
            >
              Awaaz:
            </span>
          ...
          <div className="max-w-4xl mx-auto sm:mx-0 text-center sm:text-left">
            <p className="mt-4 sm:mt-5 text-[#223843] text-base sm:text-lg md:text-xl">
              ...
              awareness, and influence decision-makers.
            </p>
            <div className="flex flex-col sm:flex-row sm:space-x-4 mt-4 sm:mt-6 justify-center sm:justify-start">
              <Link
                href={"/sign-up"}
                className="py-3 px-6 inline-flex items-center font-semibold text-sm sm:text-base rounded-md border border-[#CA3C25] text-[#CA3C25] bg-transparent transition duration-300 ease-in-out transform hover:bg-[#CA3C25] hover:text-white hover:scale-105 focus:outline-none"
              >
                Get Started
              </Link>
              ...
              <Link
                ...
                className="mt-3 sm:mt-0 py-3 px-6 inline-flex items-center font-semibold text-sm sm:text-base rounded-md bg-[#CA3C25] text-white transition duration-300 ease-in-out transform hover:bg-[#b3321e] hover:shadow-lg hover:-translate-y-1 focus:outline-none disabled:opacity-50 disabled:pointer-events-none"
              >
                Create Petition
              </Link>
            </div>
